...
elif_branch, else_branch, var_list, var_list_element = G.NonTerminals('elif_branch else_branch var_list var_list_element')
...
#region Terminals
colon, semicolon, comma, opar, cpar, arrow, lcurly, rcurly, at, double_at, assignment_op, obracket, cbracket, bar_bar = G.Terminals(': ; , ( ) -> { } @ @@ := [ ] ||')
