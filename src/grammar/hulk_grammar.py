...
single_expr_lv2 %= single_expr_lv2 + is_t + id, lambda h, s: is_node(s[1], s[3])
single_expr_lv2 %= single_expr_lv2 + as_t + id, lambda h, s: as_node(s[1], s[3])
...
# string_expr %= general_atom, lambda h, s: s[1]
...
general_atom %= id + func_call_list, lambda h, s: property_call_node(s[1], s[2])
